            ...
            <div className="p-4">
                ...
                <div className="space-y-2">
                    <button
                        ...
                        className="w-full bg-[var(--color-primary)] hover:bg-[var(--color-sigma-blue)] text-white text-sm font-semibold py-2.5 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
                    >
