...
export default function Edit({ application, cohorts }: { application: any, cohorts: any[] }) {
    const { data, setData, put, processing, errors } = useForm({
        name: application.name,
        email: application.email,
        phone_number: application.phone_number,
        organization: application.organization || '',
        cohort_id: application.cohort_id.toString(),
    });
            ...
            <div className="max-w-2xl mx-auto bg-white p-8 rounded-md shadow">
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <Select defaultValue={data.cohort_id} onValueChange={(value) => setData('cohort_id', value)}>
                            <SelectTrigger>
